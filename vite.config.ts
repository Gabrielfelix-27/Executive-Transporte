  ...
  server: {
    ...
    proxy: {
      '/api/infinitepay': {
        ...
        configure: (proxy, _options) => {
          proxy.on('error', (err, _req, _res) => {
            console.log('❌ Erro no proxy InfinitePay:', err);
          });
          proxy.on('proxyReq', (proxyReq, req, _res) => {
            console.log('🔄 Proxy InfinitePay - Enviando:', req.method, req.url);
          });
          proxy.on('proxyRes', (proxyRes, req, _res) => {
            console.log('✅ Proxy InfinitePay - Resposta:', proxyRes.statusCode, req.url);
          });
        },
      },
      '/api/infinitepay-proxy': {
        ...
        configure: (proxy, _options) => {
          proxy.on('error', (err, _req, _res) => {
            console.log('❌ Erro no proxy InfinitePay-Proxy:', err);
          });
          proxy.on('proxyReq', (proxyReq, req, _res) => {
            console.log('🔄 Proxy InfinitePay-Proxy - Enviando:', req.method, req.url);
          });
          proxy.on('proxyRes', (proxyRes, req, _res) => {
            console.log('✅ Proxy InfinitePay-Proxy - Resposta:', proxyRes.statusCode, req.url);
          });
        },
      }
    },
